...
const styles = StyleSheet.create({
    container: {
        flex: 1, paddingTop: 60, paddingHorizontal: 16, backgroundColor:
    ...
    input: {
        borderWidth: 1, borderColor: '#D8DEE9', borderRadius: 8, padding: 10,
    ...
    celebration: {
        fontSize: 16, fontWeight: 'bold', color: '#1E8A7A', textAlign:

            'center', marginVertical: 12
    },

    quote: {
        fontStyle: 'italic', color: '#6B7280', marginBottom: 16, textAlign: 'center'
    },
});